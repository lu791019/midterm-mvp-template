...
| **13:50-14:15** | **25** | **實作 1** | 巡場、解答環境問題 | clone → 環境 → 選題 → 討論 | Section 0 |
| 14:15-14:20 | 5 | 交流 | 走動聽 | 分享選題和資料初印象 | |
| 14:20-14:30 | 10 | ETL 講解 | 清洗重點 + 各題難點 | 聽 | |
| **14:30-15:15** | **45** | **實作 2** | 巡場 | ETL：raw → cleaned → SQL 統計 | Section 1-3 |
| 15:15-15:20 | 5 | 交流 | 走動聽 | 比較清洗策略和統計發現 | |
| 15:20-15:25 | 5 | LLM + API 講解 | demo prompt + fallback + API | 聽 | |
| **15:25-15:55** | **30** | **實作 3** | 巡場 | LLM → report → FastAPI | Section 4-8 |
| 15:55-16:00 | 5 | 準備 Demo | 提醒準備 | 整理要 show 的畫面 | |
| **16:00-16:15** | **15** | **Demo** | 計時 + 點評 | 每組推派 1 人 × 3 min | |
| 16:15-16:30 | 15 | 收尾 | 升級路線 + Next Step + Q&A | | |
