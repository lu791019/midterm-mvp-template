...
|------|------|------|-----------|-----------|---------|
| 13:30-13:55 | 25 | 開場講解 | 投影 demo pipeline + 概念 + 題目導覽 | 聽、看 | |
| **13:55-14:40** | **45** | **實作 1** | 巡場、解答環境問題 | clone → 選題 → 看 spec → ETL → SQL | Section 0-3 |
| 14:40-14:45 | 5 | 交流 | 巡場觀察進度 | 組內分享選題和清洗策略 | |
| 14:45-14:55 | 10 | LLM + API 講解 | demo prompt、API vs fallback、Data Product | 聽 | |
| **14:55-15:40** | **45** | **實作 2** | 巡場、解答 API/prompt 問題 | LLM → 驗證 → 報告 → 打包 → FastAPI | Section 4-8 |
| 15:40-15:45 | 5 | 準備 Demo | 提醒準備 | 整理要 show 的畫面 | |
| **15:45-16:15** | **30** | **閃電秀** | 計時 + 穿插點評 | 每人 ~2 分鐘上台 | |
| 16:15-16:30 | 15 | 收尾 | 升級路線 + Q&A | 打包帶走 | |
...
>
> 最後每人 2 分鐘上台 Demo。show Notebook 或截圖就好。
>
> 現在選題、開環境。」
