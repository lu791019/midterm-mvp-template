...
5 分鐘後交流：打開你的 requirements_spec.md 最下面的『交流引導』，組員會問你 4 個問題。開始。」
...
## Part 4：閃電秀預演 + Demo + 收尾（15:55-16:30）

### 交流 2：閃電秀預演 (10 min)

「實作結束。正式 Demo 之前，先在組內預演。每組派 2~3 人，每人 3 分鐘，向組員說明你做了什麼。

打開你的 requirements_spec.md 最下面的『閃電秀預演』引導——講清楚：題目解決什麼問題、做了哪些清洗和分析、最有趣的發現、LLM 做了什麼。

組員給回饋，幫忙精煉等等正式上台的重點。開始。」

### Demo (15 min)

「每組推派 1 人上台，3 分鐘。剛才預演過了，這次更精煉。

結構：問題 → 清洗 → LLM → output → 升級方向。
